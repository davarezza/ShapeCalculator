...
<div class="container">
        <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
            <h1 class="mb-3 fs-4">Aplikasi Menghitung Bangun Ruang Kubus</h1>
            <hr class="border border-danger border-2 opacity-25">
            <h3 class="mb-3 fs-4">Volume Kubus</h3>
            <div class="mb-3">
                <label for="sisivolume1" class="form-label">Sisi</label>
                <input type="number" class="form-control" id="sisivolume1" name="sisivolume1" placeholder="Masukkan Angka..." required>
            </div>
        ...
        <?php
            if (isset($_POST['sisivolume1'])) {
                $sisivolume1 = $_POST['sisivolume1'];
                $hasil = $sisivolume1 * $sisivolume1 * $sisivolume1;
...
<div class="container mb-4">
        <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
            <h1 class="mb-3 fs-4">Aplikasi Menghitung Bangun Ruang Kubus</h1>
            <hr class="border border-danger border-2 opacity-25">
            <h3 class="mb-3 fs-4">Luas Permukaan Kubus</h3>
            <div class="mb-3">
                <label for="6" class="form-label">Jaring-Jaring</label>
                <input class="form-control" type="number" value="6" disabled readonly>
            </div>
            <div class="mb-3">
                <label for="sisi1" class="form-label">Sisi</label>
                <input type="number" class="form-control" id="sisi1" name="sisi1" placeholder="Masukkan Angka..." required>
            </div>
            <button type="submit" class="btn btn-primary">Jumlahkan</button>
